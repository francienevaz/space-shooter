...
const aliensImg = ['img/enemy1.png', 'img/enemy2.png', 'img/enemy3.png'];
...
function moveLaser (laser, alien) {
...
function createAliens () {
   ...
   let alienSprite = aliensImg[Math.floor(Math.random() * aliensImg.length)];  // imagens aleatórias
